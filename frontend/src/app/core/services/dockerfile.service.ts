...
export class DockerfileService {
  private apiUrl = `${environment.dockerfileServiceUrl}/dockerfiles`;
  private projectUrl = `${environment.projectServiceUrl}/projects`;
  private userUrl = `${environment.userServiceUrl}/users`;
